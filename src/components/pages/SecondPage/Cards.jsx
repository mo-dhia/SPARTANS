...
function Cards({ setModal }) {
  const [activePanel, setActivePanel] = useState(new Date().getDay());

  return (
    <div >
      <div className="panel-container">
        <div onClick={() => setActivePanel(1)} className={activePanel === 1 ? "panel active" : "panel"} style={{
          backgroundImage:
          ...
          <img onClick={() => activePanel === 1 ? setModal(true) : null} src={Edit} className="editIcon" />
          <h3>Monday</h3>
        </div>
        <div onClick={() => setActivePanel(2)} className={activePanel === 2 ? "panel active" : "panel"} style={{
          backgroundImage:
          ...
          <img onClick={() => activePanel === 2 ? setModal(true) : null} src={Edit} className="editIcon" />
          <h3>Tuesday</h3>
        </div>
        <div onClick={() => setActivePanel(3)} className={activePanel === 3 ? "panel active" : "panel"} style={{
          backgroundImage:
          ...
          <img onClick={() => activePanel === 3 ? setModal(true) : null} src={Edit} className="editIcon" />
          <h3>Thursday</h3>
        </div>
        <div onClick={() => setActivePanel(4)} className={activePanel === 4 ? "panel active" : "panel"} style={{
          backgroundImage:
          ...
          <img onClick={() => activePanel === 4 ? setModal(true) : null} src={Edit} className="editIcon" />
          <h3>Wendsday</h3>
        </div>
        <div onClick={() => setActivePanel(5)} className={activePanel === 5 ? "panel active" : "panel"} style={{
          backgroundImage:
          ...
          <img onClick={() => activePanel === 5 ? setModal(true) : null} src={Edit} className="editIcon" />
          <h3>Friday</h3>
        </div>
        <div onClick={() => setActivePanel(6)} className={activePanel === 6 ? "panel active" : "panel"} style={{
          backgroundImage:
          ...
          <img onClick={() => activePanel === 6 ? setModal(true) : null} src={Edit} className="editIcon" />
          <h3>Saturday</h3>
        </div>
        <div onClick={() => setActivePanel(0)} className={activePanel === 0 ? "panel active" : "panel"} style={{
          backgroundImage:
          ...
          <img onClick={() => activePanel === 7 ? setModal(true) : null} src={Edit} className="editIcon" />
          <h3>Sunday</h3>
        </div>
